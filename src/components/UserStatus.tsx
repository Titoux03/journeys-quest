...
export const UserStatus: React.FC = () => {
  ...
  if (!user) {
    return (
      <div className="flex items-center justify-between p-4 bg-card/50 backdrop-blur-sm border-b border-border/30">
        ...
        <button
          ...
          className="flex items-center space-x-2 px-3 py-2 text-sm rounded-lg bg-primary/10 text-primary hover:bg-primary/20 transition-colors"
        >
