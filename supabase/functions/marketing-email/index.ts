    ...
    for (const profile of profiles) {
      try {
            ...
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; border-radius: 10px; overflow: hidden;">
              ...
              <div style="background: white; color: #333; padding: 40px 30px;">
                ...
                <div style="text-align: center; margin: 30px 0;">
                  ...
                  <a href="${Deno.env.get("SUPABASE_URL")?.replace("supabase.co", "lovable.app") || "https://fgoyvsnsoheboywgtgvi.lovable.app"}" 
        ...
        if (emailResponse.error) {
          logStep("ERROR sending email", { userId: profile.user_id, error: emailResponse.error });
        } else {
          logStep("Email sent successfully", { userId: profile.user_id, emailId: emailResponse.data?.id });
        }
